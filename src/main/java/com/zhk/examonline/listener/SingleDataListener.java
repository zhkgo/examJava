...
@Slf4j
public class SingleDataListener extends AnalysisEventListener<SingleChoice> {
    /**
    ...
    private Integer id;
    public SingleDataListener(QuestionService questionService,QuestionParserUtil questionParserUtil,Integer id) {
     ...
     */
    @Override
    public void invoke(SingleChoice data, AnalysisContext context) {
