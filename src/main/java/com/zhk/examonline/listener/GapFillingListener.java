...
import com.zhk.examonline.domain.excel.GapFilling;
...
@Slf4j
public class GapFillingListener extends AnalysisEventListener<GapFilling> {
    /**
    ...
    private Integer id;
    public GapFillingListener(QuestionService questionService, QuestionParserUtil questionParserUtil, Integer id) {
     ...
     */
    @Override
    public void invoke(GapFilling data, AnalysisContext context) {
