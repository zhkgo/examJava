...
import com.zhk.examonline.domain.excel.ShortAnswer;
import com.zhk.examonline.domain.excel.SingleChoice;
...
@Slf4j
public class ShortAnswerListener extends AnalysisEventListener<ShortAnswer> {
    /**
    ...
    private Integer id;
    public ShortAnswerListener(QuestionService questionService, QuestionParserUtil questionParserUtil, Integer id) {
     ...
     */
    @Override
    public void invoke(ShortAnswer data, AnalysisContext context) {
