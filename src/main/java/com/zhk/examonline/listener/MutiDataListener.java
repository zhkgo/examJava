...
@Slf4j
public class MutiDataListener extends AnalysisEventListener<MutiChoice> {
    /**
    ...
    private Integer id;
    public MutiDataListener(QuestionService questionService, QuestionParserUtil questionParserUtil, Integer id) {
     ...
     */
    @Override
    public void invoke(MutiChoice data, AnalysisContext context) {
